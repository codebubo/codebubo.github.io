---
title: "for-loopar<br>i Python"
from: markdown+emoji
title-slide-attributes:
  data-background-image: cover-background.png
...
Om det hade varit en `while`-loop som skulle snurra fem varv skulle ett
...
#| echo: true
#| classes: output-black-on-white
# Dettta program beräknar och skriver ut "tolvans tabell"
for i in range(1, 13):
