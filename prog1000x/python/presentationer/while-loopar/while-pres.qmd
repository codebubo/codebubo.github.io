...
i = 1
while i <= 5: # Blocket upprepas så länge uttrycket är sant
    print(i, end=" ")
    i += 1  # i ökar med 1
...
# Detta program beräknar summan av ett antal tal
summa = 0
while True: # Alltid sant!
    tal = int(input("Ange ett valfritt tal, noll avslutar -> "))
    if tal == 0:
        break # Här bryts loopen om villkoret ovan är uppfyllt
    summa += tal
print(f"Summan är {summa}")
```
