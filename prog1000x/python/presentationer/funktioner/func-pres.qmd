...
title-slide-attributes:
  data-background-image: "cover-background.jpg"
...
tal_1 = 10
tal_2 = 20
summa = add(tal_1, tal_2) # Ger felmeddelande!
...
Funktionen anropas t ex enligt `total = add(1, 2)`.
Här kallas talen `1` och `2` i anropet för *argument*.

Variabeln `total` antar det värde som `return` skickar tillbaka.
...
# summa inte räcker till denna nivå i programmet.
print(summa)
```
