...
**I övningarna 1 -- 7 ska du använda `while`-loopar i din lösning**.
---
...
:::{.callout-tip collapse="true" icon="false" title="Lösningsförslag övning 1"}
...
Ett program som ger en utmatning enligt uppgiften, dvs som ställer ental över
ental och tiotal över tiotal, ser ut så här:
...
`print`-satsen tar en s.k parameter, `end`, vilken gör att radslutet blir det
eller de tecken som anges i den tilldelande strängen (i det här fallet ett
mellanslag). Utelämnas `end`-satsen så skapas en ny rad.
:::
...
Metoden är att gissningarna sker i en loop vars enda villkor är `True` (en
"oändlig" loop). När spelaren har gissat rätt så avbryts loopen med `break`.
:::
...
Observera att det är viktigt att uppdatera variablerna `x` och `y` på rätt
ställen i den nästlade loopen.
...
:::{.callout-tip collapse="true" icon="false" title="Lösningsförslag övning 6"}
...
**Figur C**, här blir villkoren olika beroende på om radnumret är jämnt eller
udda:

* Om både rad- och kolumnnumret är jämnt så ska en `*` skrivas ut
* Om radnumret är jämnt och kolumnnumret är udda så ska ett mellanslag skrivas
  ut
* Om både rad- och kolumnnummer är udda så ska en `*` skrivas ut
* Om radnumret är udda och kolumnnumret är jämnt så ska ett mellanslag skrivas
  ut
...
Detta Python-program fungerar som en sorts meny där användaren måste göra
giltiga val. Om valet är ogiltigt kommer användaren att komma tillbaka till
samma läge för att välja om. Här ser vi exempel på "oändliga loopar" och hur
programmet kan avgöra om ett alternativ bland flera är giltigt.
...
**I övningarna 8 -- 10 ska du använda `for`-loopar i din lösning**.
---
...
:::{.callout-tip collapse="true" icon="false" title="Lösningsförslag övning 8A"}
...
:::{.callout-tip collapse="true" icon="false" title="Lösningsförslag övning 8B"}
...
:::{.callout-tip collapse="true" icon="false" title="Lösningsförslag övning 8C"}
...
:::{.callout-tip collapse="true" icon="false" title="Lösningsförslag övning 8D"}
...
:::{.callout-tip collapse="true" icon="false" title="Lösningsförslag övning 9"}
...
### Övning 10
I [övning 4](#övning-4) skapade du ett program som lät en spelare gissa ett tal
från 1
...
:::{.callout-tip collapse="true" icon="false" title="Lösningsförslag övning 10"}

Lösningen görs med en yttre `for`-loop (där vi känner till antalet varv från
början) och en inre `while`-loop (där antalet varv beror på hur många
gissningar som krävs).
...
## Övningar utan lösningsförslag

**Dessa övningar är tänkta för att på egen hand testa förståelsen för
loopar, och ska kunna lösas enbart med information från presentationer
och information kring tidigare övningar.**
---
...
Se [tipset till Övning 2 ovan](#slumptalstips) för att skapa slumpvisa
...
[Övning 5 på sidan Villkor](../villkor/index.qmd#villkor-skottar)
