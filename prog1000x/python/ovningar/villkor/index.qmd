...
Skapa ett program i [EduBlocks](https://app.edublocks.org/) som ber dig mata
ingett belopp med pengar. Programmet ska avgöra om det räcker till att köpa ett
smycke av järn, silver eller guld. Skapa även ett flödesschema för programmet.
...
Skapa ett program i [EduBlocks](https://app.edublocks.org/) som läser in
längderna på tre sidor. Programmet ska sedan avgöra om dessa sidor kan ingå i
