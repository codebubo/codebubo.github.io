...
så har den `nyckel:värde`-par. Exempel:

```python
my_dict = {"Kalle":"Anka", 10:"Tio"}

print(my_dict["Kalle"]) # Skriver ut Anka
print(my_dict[10])      # Skriver ut Tio

# Värdena kan loopas igenom på samma sätt som en listas värden
for vals in my_dict:
    print(vals, end = " ") # Skriver ut "Anka 10" på en rad

# Det går även att lägga till nyckel:värde-par i en dictionary...
my_dict["Tjugo":20]

# ...eller ta bort värden
del my_dict ["Kalle"]
