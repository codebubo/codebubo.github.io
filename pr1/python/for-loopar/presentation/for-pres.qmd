...
for element in lista:
    print(element, end=" ")
print(f"\nProgrammet avslutas eftersom listan är slut")
```
...
```{python}
#| echo: true
for i in range(3, 10):   # Här skapas listan
    print(2*i, end=" ")  # Här dubblas respektive element och skrivs ut
```

:::{.v-space}
:::

Funktionen `range(3, 10)` skapar listan `[3, 4, 5, 6, 7, 8, 9]`

Om det hade varit en `while`-loop som skulle snurra sju varav skulle ett
