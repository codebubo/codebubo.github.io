...
### Uppgift 8
Skapa program, som med hjälp av en eller flera loopar, ger följande respektive
utskrift:
...
### Uppgift 10
I uppgift 4 skapade du ett program som lät en spelare gissa ett tal från 1
...
I ett spel som kan användas när man lär sig division sitter deltagarna i en
...
tre är jämnt delbart med tre, detsamma gäller den person som ska säga "sex"
