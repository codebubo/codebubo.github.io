...
Här är en lista med tal. Låt oss söka efter talet `14` med hjälp av algoritm.
...
resulterar alltid i ett heltal. Exempel:
...
Skapa en (sorterad) lista med $1\,000$ element med heltalsvärden mellan $0$ och
$2\,000$. Hur många sökningar måste maximalt göras för tal som finns respektive
saknas i listan?