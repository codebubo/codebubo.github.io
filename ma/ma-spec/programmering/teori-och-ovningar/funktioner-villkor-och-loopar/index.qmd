...
:::{.callout-tip collapse="true" icon="false" title="Lösningsförslag uppgift 201"}

Uppgiften kan antingen lösas i *Command Window* eller genom att skapa en fil
i Octave.
...
:::{.callout-tip collapse="true" icon="false" title="Lösningsförslag uppgift 202"}
...
```
octave:1> logn(9, 3) # Beräknar logaritmen av 9 i basen 3
ans = 2
octave:2> logn([1 3 9 27 81], 3)
ans =

   0   1   2   3   4
```

:::{.callout-tip collapse="true" icon="false" title="Lösningsförslag uppgift 203"}
...
multiplicera elementen i två vektorer och returnera summan av produkterna.
...
```
octave:1> dotmul([1 2 3], [4 5 6])
ans = 32
```

:::{.callout-tip collapse="true" icon="false" title="Lösningsförslag uppgift 204"}
...
```
octave:1> [h_ang m_ang s_ang] = clock_hands_angles(03, 00, 00)
h_ang = 0
m_ang = 90
s_ang = 90
```
...
```
octave:2> [h_ang m_ang s_ang] = clock_hands_angles(13, 45, 30)
h_ang = 37.250
m_ang = 177
s_ang = 270
```

:::{.callout-tip collapse="true" icon="false" title="Lösningsförslag uppgift 205"}
...
I spelet LOTTO slumpas sju nummer bland heltalen 1, 2, 3,. . . , 35. Spelaren
ska gissa vilka nummer som kommer att slumpas fram och hoppas förstås att få
alla rätt (vilket brukar rendera en vinst runt 1 miljon kronor).
...
:::{.callout-tip collapse="true" icon="false" title="Lösningsförslag uppgift 206"}
...
Nedan följer skriptet `lotto`, som kan sparas under valfritt filnamn.
...
Skriv en funktion `lottovinst` som använder funktionen `lottoeval` från uppgift
[206](#uppgift-206). Funktionen `lottovinst` ska slumpa fram en tippad LOTTO-rad
...
```
octave:3> tic; lottovinst(5); toc
antal_dragningar = 1331
antal_ratt = 5
Elapsed time is 0.948647 seconds.
```

:::{.callout-tip collapse="true" icon="false" title="Lösningsförslag uppgift 207"}
